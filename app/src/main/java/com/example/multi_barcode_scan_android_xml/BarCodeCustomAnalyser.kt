...
class BarCodeCustomAnalyser(private val barcodeListener: BarcodeAnalyzerListener) :
    ImageAnalysis.Analyzer {

    /**
     * if  you want to  scan QR codes as well you need to uncomment
     * the  FORMAT_QR_CODE option and vice  versa
     */
